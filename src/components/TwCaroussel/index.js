    ...
    >
      ...
      <div class="relative w-full overflow-hidden after:clear-both after:block after:content-['']">
        ...
        >
          ...
          <nav
            class="sticky top-0 lg:hidden xs:block relative flex w-full flex-wrap items-center justify-between py-3 text-white shadow-lg lg:flex-wrap lg:justify-start"
            data-te-navbar-ref
            style={{
              backgroundColor: "transparent",
              position: "absolute",
