  ...
  return (
    ...
    >
      ...
      <div class="relative w-full overflow-hidden after:clear-both after:block after:content-['']">
        ...
        >
          <nav
            class="relative flex flex-wrap items-center justify-between px-9 py-2 mb-2"
            style={{
              ...
              >
                <ul class="flex flex-col lg:flex-row list-none ml-auto">
                  ...
                  <li class="nav-item" data-te-dropdown-ref>
                    <a
                      class="    hover:text-teal-600 px-5 py-2 
                                                    flex items-center text-xs uppercase 
                                                    font-bold leading-snug text-white"
                      href="#formations"
          ...
          <img
            ...
            alt="..."
          />
          <div class="absolute inset-x-[15%] bottom-5 hidden py-9 text-center text-white md:block my-28">
            <h1 class="text-xl" style={{ fontSize: "35px" }}>
        ...
        >
          <nav
            class="relative flex flex-wrap items-center justify-between px-9 py-4 mb-3"
            style={{
              backgroundColor: "transparent",
              position: "absolute",
              zIndex: "3",
            ...
            <div class="container px-4 mx-auto flex flex-wrap items-center justify-between">
              ...
              >
                <ul class="flex flex-col lg:flex-row list-none ml-auto">
                  <li class="nav-item">
                    <a
                      class="bg-teal-600 text-white rounded-md px-5 py-2 flex items-center text-xs uppercase font-bold leading-snug text-white hover:opacity-75"
                      href="#pablo"
                      aria-current="page"
                    >
                      Acceuil
                  ...
                  <li class="nav-item">
                    <a
                      class="hover:bg-teal-600 hover:text-white rounded-md px-5 hover:ml-2 py-2 flex items-center text-xs uppercase font-bold leading-snug text-white"
                      href="#pablo"
                    >
                      Formations
                    </a>
                  ...
                  <li class="nav-item">
                    <a
                      class="hover:bg-teal-600 hover:text-white rounded-md px-5 py-2 flex items-center text-xs uppercase font-bold leading-snug text-white"
                      href="#pablo"
                    >
                      A propos
                    </a>
