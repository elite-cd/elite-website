              ...
              <div
                      ...
                      <div class="container px-4 mx-auto flex flex-wrap items-center justify-between">
                          ...
                          <div class="lg:flex flex-grow items-center" id="example-navbar-warning">
                              <ul class="flex flex-col lg:flex-row list-none ml-auto">
                                  <li class="nav-item">
                                      <a    class="text-white px-5 py-2 flex items-center text-xs uppercase font-bold leading-snug text-white activeBtn activeIndex" 
                                            href="#pablo"
                                            aria-current="page">
                                          Acceuil
                                      </a>
                                  ...
                                  <li class="nav-item">
                                      <a class={"hover:text-teal-600 px-5 py-2 flex items-center text-xs uppercase font-bold leading-snug text-white activeBtn"} 
                                         href="#formations">
                                          Formations
                                      </a>
                  ...
                  <div
                      ...
                      <p>
                        ...
                        <button
                        style={{  borderRadius: "20px", fontWeight: "600", textTransform: "initial", color: "black", height: "45px"  }}
                        type="button"
