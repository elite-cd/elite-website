    ...
    return (
      <div className={style.container}>
        ...
        <div className={style.container__preface}>
          <h3
            class="mb-28 ml-3 text-4xl max-sm:text-2xl text-center font-bold text-neutral-700">
            Qui sommes-nous ?
          </h3>
          ...
          <AnimationOnScroll animateIn="animate__fadeInUp" animateOnce="animate__fadeInUp">
            <li>
              <div class="flex-start md:flex">
                ...
                <div
                  class="mb-10 ml-6 block w-3/3 rounded-lg bg-neutral-50 p-4 shadow-md shadow-black/5 xl:w-full">
                  ...
                  <div id="accordionExample">
                    ...
                    <div
                      ...
                      <div
                        ...
                        <p class="my-6"> 
                          Chez ElITE, un apprentissage est jugé réussi lorsque les apprenants arrivent à développer
                          intérieurement, extérieurement et de manière efficace le P.A.C.T.E cad la Proactivité,
                          l'Autonomie, la Créativité, le sens du Travail et l'Excellence. Voilà sur quoi repose nos
                          formations et nous nous attendons à ce que toute personne qui passera par l'académie des
                          élites ait ses qualités dans son ADN à la fin de sa formation et qu'elle soit la meilleure dans
                          tout ce qu'elle entreprendra
                        </p>
                        </div>
                      </div>
                    </div>
            ...
            <div class="grid grid-cols-3 gap-7 md:grid-cols-3 xs:grid-cols-1 flex justify-center" style={{ width: "90%", marginBottom: "50px" }}>
              ...
              <div
                ...
                <div class="text-center mt-2">
                  <img
                    ...
                    alt="Avatar"
                  />
                  <h5 class="mb-2 text-xl font-medium leading-tight text-teal-800">Aristoste Diasonama</h5>
                  ...
                  <p class="text-neutral-500 dark:text-neutral-400">
                    ...
                    <div class="flex space-x-4 mt-4 justify-center">
                      <a href="https://www.linkedin.com/in/diasonama">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="h-8 w-8 text-teal-800">
              ...
              <div
                ...
                <div class="text-center mt-2">
                  ...
                  <p class="text-lg text-neutral-700">Directeur des opérations</p>
                  <p class="text-neutral-500 dark:text-neutral-400">
              ...
              <div
                ...
                <div class="text-center mt-2">
                  <img
                    ...
                    alt="Avatar"
                  />
                  <h5 class="mb-2 text-xl font-medium leading-tight text-teal-800">Christian Kayembe</h5>
                  <p class="text-lg text-neutral-700">Directeur de la technologie</p>
                  <p class="text-neutral-500 dark:text-neutral-400">
              ...
              <div
                ...
                <div class="text-center mt-2">
                  <img
                    ...
                    alt="Avatar"
                  />
                  <h5 class="mb-2 text-xl font-medium leading-tight text-teal-800">Pierre Diwampovesa</h5>
              ...
              <div
                ...
                <div class="text-center mt-2">
                  <img
                    ...
                    alt="Avatar"
                  />
                  <h5 class="mb-2 text-xl font-medium leading-tight text-teal-800">Kevin Diasonama</h5>
