        ...
        <div class="px-1 py-24">
          <div class="relative block md:flex items-center">
            <div class="w-full md:w-2/4 relative z-1 bg-gray-100 rounded shadow-lg overflow-hidden h-[520px]">
              ...
              <a
                class="block flex items-center justify-center bg-yellow-600 hover:bg-yellow-800 p-8 text-md font-semibold text-white uppercase w-full"
            ...
            <div
              class={
                "w-full md:w-3/4 relative z-0 px-8 md:px-0 md:py-16 " +
                style.image
              }
              style={{
                ...
                <div class="w-full max-w-md  mx-auto bg-white rounded-xl shadow-xl overflow-hidden">
                  <div class="max-w-md mx-auto">
                    ...
                    <div class="p-4 sm:p-6">
                      <p class="font-bold text-gray-700 text-[22px] leading-7 mb-1 text-lg">
                        {item.title}
                      </p>
                      <div class="flex flex-row mt-3">
                        <p class="text-[#3C3C4399] text-[17px] mr-2">DUREE</p>
                        <p class="text-[17px] font-bold text-[#0FB478] uppercase">
                          {item.timeline}
                        </p>
                      </div>
