            ...
            <div class="w-full md:w-2/4 relative z-1 bg-gray-100 rounded shadow-lg overflow-hidden h-[520px]">
              ...
              <div class="block sm:flex md:block lg:flex items-center justify-center">
                <div class="mt-8 sm:m-8 md:m-0 md:mt-8 lg:m-8 text-center">
                  ...
                  <svg class="w-8 h-8 text-teal-800 mb-6 mx-auto" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                  ...
                  <h6 class="font-medium text-xl">Durée de { course.timeline }</h6>
                </div>
            ...
            <section class="mb-10 text-gray-800 py-6">
              <div class="flex justify-center">
                <div class="text-center max-w-[700px]">
                  ...
                  Chacun des modules sera composé des matériels didactique d'actualité , des logiciels à la pointe de la technologie.
                  </p>
                </div>
              </div>
              ...
              return (
                ...
                <div class="flex">
                  <div class="shrink-0 mt-1">
                    <svg class="w-7 h-7 text-green-600" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
